  ...
  <body>
    ...
    <div class="section-body">
      <div class="grid3">
        ...
        <div><div class="field-label">Edad</div><div class="field-value">${pet ? ageLabel(pet.birth_date, pet.age, pet.fecha_nacimiento) : '—'}</div></div>
              ...
              <div key={f.id} style={{ border:`1px solid ${BRAND.tealLt}`, borderRadius:'var(--radius-lg)', marginBottom:'1.25rem', overflow:'hidden', boxShadow:'0 1px 4px rgba(49,109,116,0.08)' }}>
                ...
                <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:0, borderBottom:`1px solid ${BRAND.tealLt}` }}>
                  ...
                  <div style={{ padding:'0.7rem 1rem' }}>
                    ...
                    <div style={{ fontSize:'0.75rem', color:'var(--color-text-muted)' }}>{(pet.birth_date || pet.fecha_nacimiento || pet.age) ? ageLabel(pet.birth_date, pet.age, pet.fecha_nacimiento) : ''}{pet.weight ? ` · ${pet.weight} kg` : ''}{pet.sex ? ` · ${pet.sex}` : ''}</div>
                  </div>
                </div>
