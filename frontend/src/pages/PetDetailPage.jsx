          ...
          <div style={{ display:'flex', gap:'1.25rem', alignItems:'flex-start' }}>
            ...
            <div style={{ flex:1 }}>
              ...
              <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:'0.6rem' }}>
                <DataChip label="Edad"        value={ageLabel(pet.birth_date, pet.age, pet.fecha_nacimiento)} />
                  ...
                  <div key={h.id} style={{ border:`1px solid ${isActive ? '#fca5a5' : 'var(--color-border)'}`, borderRadius:'var(--radius-md)', padding:'0.75rem 1rem', background: isActive ? '#fff5f5' : 'var(--color-white)' }}>
                    <div style={{ display:'flex', justifyContent:'space-between', alignItems:'flex-start', gap:'0.5rem', flexWrap:'wrap' }}>
                      <div style={{ display:'flex', gap:'0.5rem', alignItems:'center', flexWrap:'wrap' }}>
                        ...
                        {h.viral && (
                          <span style={{ background:'#fef2f2', color:'#dc2626', padding:'2px 9px', borderRadius:999, fontSize:'0.7rem', fontWeight:700, border:'1px solid #fca5a5' }}>
                            🦠 Viral
                          </span>
                        )}
